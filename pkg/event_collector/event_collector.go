// Package event_collector contains all the business logic for the event collection
package event_collector // import "github.com/joincivil/civil-events-crawler/pkg/retriever"
