...
// File was generated at 2019-12-19 21:31:53.096828 +0000 UTC
package filterer
...
func (f *MultiSigWalletFactoryContractFilterers) startFilterContractInstantiation(startBlock uint64, pastEvents []*model.Event) ([]*model.Event, error) {
	...
	log.Infof("Filtering MultiSigWalletFactoryContract ContractInstantiation for %v at block %v", f.contractAddress.Hex(), startBlock)
	...
	for {
		...
		if err == nil {
			log.Infof("Done filter: MultiSigWalletFactoryContract ContractInstantiation for %v", f.contractAddress.Hex())
			break
		}
		if retry >= maxRetries {
	...
	log.Infof("MultiSigWalletFactoryContract ContractInstantiation added: %v", numEventsAdded)
	return pastEvents, nil
}
