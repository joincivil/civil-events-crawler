...
// File was generated at 2019-12-05 18:14:32.247738 +0000 UTC
package filterer
...
func (f *NewsroomContractFilterers) StartNewsroomContractFilterers(client bind.ContractBackend, pastEvents []*model.Event) (error, []*model.Event) {
	...
	if !specs.IsEventDisabled("NewsroomContract", "ContentPublished") {
		wg.Add(1)
		go func() {
			filterFunc := func() {
	...
	if !specs.IsEventDisabled("NewsroomContract", "NameChanged") {
		wg.Add(1)
		go func() {
			filterFunc := func() {
	...
	if !specs.IsEventDisabled("NewsroomContract", "OwnershipRenounced") {
		wg.Add(1)
		go func() {
			filterFunc := func() {
	...
	if !specs.IsEventDisabled("NewsroomContract", "OwnershipTransferred") {
		wg.Add(1)
		go func() {
			filterFunc := func() {
	...
	if !specs.IsEventDisabled("NewsroomContract", "RevisionSigned") {
		wg.Add(1)
		go func() {
			filterFunc := func() {
	...
	if !specs.IsEventDisabled("NewsroomContract", "RevisionUpdated") {
		wg.Add(1)
		go func() {
			filterFunc := func() {
	...
	if !specs.IsEventDisabled("NewsroomContract", "RoleAdded") {
		wg.Add(1)
		go func() {
			filterFunc := func() {
	...
	if !specs.IsEventDisabled("NewsroomContract", "RoleRemoved") {
		wg.Add(1)
		go func() {
			filterFunc := func() {
