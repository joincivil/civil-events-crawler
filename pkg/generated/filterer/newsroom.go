...
// File was generated at 2018-06-14 20:47:37.752987148 +0000 UTC
package filterer
...
func (f *NewsroomContractFilterers) startFilterContentPublished(startBlock uint64, pastEvents *[]model.CivilEvent) error {
	...
	nextEvent := itr.Next()
	for nextEvent {
		civilEvent := model.NewCivilEvent("ContentPublished", f.contractAddress, itr.Event)
...
func (f *NewsroomContractFilterers) startFilterNameChanged(startBlock uint64, pastEvents *[]model.CivilEvent) error {
	...
	nextEvent := itr.Next()
	for nextEvent {
		civilEvent := model.NewCivilEvent("NameChanged", f.contractAddress, itr.Event)
		*pastEvents = append(*pastEvents, *civilEvent)
		nextEvent = itr.Next()
	}
	return nil
...
func (f *NewsroomContractFilterers) startFilterOwnershipTransferred(startBlock uint64, pastEvents *[]model.CivilEvent) error {
	...
	nextEvent := itr.Next()
	for nextEvent {
		civilEvent := model.NewCivilEvent("OwnershipTransferred", f.contractAddress, itr.Event)
		*pastEvents = append(*pastEvents, *civilEvent)
		nextEvent = itr.Next()
	}
	return nil
...
func (f *NewsroomContractFilterers) startFilterRevisionSigned(startBlock uint64, pastEvents *[]model.CivilEvent) error {
	...
	nextEvent := itr.Next()
	for nextEvent {
		civilEvent := model.NewCivilEvent("RevisionSigned", f.contractAddress, itr.Event)
		*pastEvents = append(*pastEvents, *civilEvent)
		nextEvent = itr.Next()
	}
	return nil
...
func (f *NewsroomContractFilterers) startFilterRevisionUpdated(startBlock uint64, pastEvents *[]model.CivilEvent) error {
	...
	nextEvent := itr.Next()
	for nextEvent {
		civilEvent := model.NewCivilEvent("RevisionUpdated", f.contractAddress, itr.Event)
		*pastEvents = append(*pastEvents, *civilEvent)
		nextEvent = itr.Next()
	}
	return nil
...
func (f *NewsroomContractFilterers) startFilterRoleAdded(startBlock uint64, pastEvents *[]model.CivilEvent) error {
	...
	nextEvent := itr.Next()
	for nextEvent {
		civilEvent := model.NewCivilEvent("RoleAdded", f.contractAddress, itr.Event)
		*pastEvents = append(*pastEvents, *civilEvent)
		nextEvent = itr.Next()
	}
	return nil
...
func (f *NewsroomContractFilterers) startFilterRoleRemoved(startBlock uint64, pastEvents *[]model.CivilEvent) error {
	...
	nextEvent := itr.Next()
	for nextEvent {
		civilEvent := model.NewCivilEvent("RoleRemoved", f.contractAddress, itr.Event)
		*pastEvents = append(*pastEvents, *civilEvent)
		nextEvent = itr.Next()
	}
	return nil
