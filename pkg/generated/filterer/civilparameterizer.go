...
// File was generated at 2019-12-05 18:14:40.427369 +0000 UTC
package filterer
...
func (f *ParameterizerContractFilterers) StartParameterizerContractFilterers(client bind.ContractBackend, pastEvents []*model.Event) (error, []*model.Event) {
	...
	if !specs.IsEventDisabled("ParameterizerContract", "ChallengeFailed") {
		wg.Add(1)
		go func() {
			filterFunc := func() {
	...
	if !specs.IsEventDisabled("ParameterizerContract", "ChallengeSucceeded") {
		wg.Add(1)
		go func() {
			filterFunc := func() {
	...
	if !specs.IsEventDisabled("ParameterizerContract", "NewChallenge") {
		wg.Add(1)
		go func() {
			filterFunc := func() {
	...
	if !specs.IsEventDisabled("ParameterizerContract", "ProposalAccepted") {
		wg.Add(1)
		go func() {
			filterFunc := func() {
	...
	if !specs.IsEventDisabled("ParameterizerContract", "ProposalExpired") {
		wg.Add(1)
		go func() {
			filterFunc := func() {
	...
	if !specs.IsEventDisabled("ParameterizerContract", "ReparameterizationProposal") {
		wg.Add(1)
		go func() {
			filterFunc := func() {
	...
	if !specs.IsEventDisabled("ParameterizerContract", "RewardClaimed") {
		wg.Add(1)
		go func() {
			filterFunc := func() {
