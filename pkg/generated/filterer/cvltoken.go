...
// File was generated at 2019-12-05 18:14:37.650869 +0000 UTC
package filterer
...
func (f *CVLTokenContractFilterers) StartCVLTokenContractFilterers(client bind.ContractBackend, pastEvents []*model.Event) (error, []*model.Event) {
	...
	if !specs.IsEventDisabled("CVLTokenContract", "Approval") {
		wg.Add(1)
		go func() {
			filterFunc := func() {
	...
	if !specs.IsEventDisabled("CVLTokenContract", "OwnershipRenounced") {
		wg.Add(1)
		go func() {
			filterFunc := func() {
	...
	if !specs.IsEventDisabled("CVLTokenContract", "OwnershipTransferred") {
		wg.Add(1)
		go func() {
			filterFunc := func() {
	...
	if !specs.IsEventDisabled("CVLTokenContract", "Transfer") {
		wg.Add(1)
		go func() {
			filterFunc := func() {
