...
// File was generated at 2019-12-05 18:54:56.600428 +0000 UTC
package watcher
...
func NewParameterizerContractWatchersAllEvents(contractAddress common.Address) *ParameterizerContractWatchers {
	return &ParameterizerContractWatchers{
		contractAddress: contractAddress,
		enableAll:       true,
	}
...
func (w *ParameterizerContractWatchers) StartParameterizerContractWatchers(client bind.ContractBackend,
	...
	if w.enableAll || specs.IsListenerEnabledForEvent("ParameterizerContract", "ChallengeFailed") {
	...
	if w.enableAll || specs.IsListenerEnabledForEvent("ParameterizerContract", "ChallengeSucceeded") {
	...
	if w.enableAll || specs.IsListenerEnabledForEvent("ParameterizerContract", "NewChallenge") {
	...
	if w.enableAll || specs.IsListenerEnabledForEvent("ParameterizerContract", "ProposalAccepted") {
	...
	if w.enableAll || specs.IsListenerEnabledForEvent("ParameterizerContract", "ProposalExpired") {
	...
	if w.enableAll || specs.IsListenerEnabledForEvent("ParameterizerContract", "ReparameterizationProposal") {
	...
	if w.enableAll || specs.IsListenerEnabledForEvent("ParameterizerContract", "RewardClaimed") {
