...
// File was generated at 2019-12-05 18:54:51.975352 +0000 UTC
package watcher
...
func NewCivilPLCRVotingContractWatchersAllEvents(contractAddress common.Address) *CivilPLCRVotingContractWatchers {
	return &CivilPLCRVotingContractWatchers{
		contractAddress: contractAddress,
		enableAll:       true,
	}
...
func (w *CivilPLCRVotingContractWatchers) StartCivilPLCRVotingContractWatchers(client bind.ContractBackend,
	...
	if w.enableAll || specs.IsListenerEnabledForEvent("CivilPLCRVotingContract", "PollCreated") {
	...
	if w.enableAll || specs.IsListenerEnabledForEvent("CivilPLCRVotingContract", "TokensRescued") {
	...
	if w.enableAll || specs.IsListenerEnabledForEvent("CivilPLCRVotingContract", "VoteCommitted") {
	...
	if w.enableAll || specs.IsListenerEnabledForEvent("CivilPLCRVotingContract", "VoteRevealed") {
	...
	if w.enableAll || specs.IsListenerEnabledForEvent("CivilPLCRVotingContract", "VotingRightsGranted") {
	...
	if w.enableAll || specs.IsListenerEnabledForEvent("CivilPLCRVotingContract", "VotingRightsWithdrawn") {
