...
// File was generated at 2019-03-05 02:17:41.608139 +0000 UTC
package watcher
	...
	return event.NewSubscription(func(quit <-chan struct{}) error {
		...
		startupFn := func() (event.Subscription, chan *contract.CivilTCRContractAppealGranted, error) {
			...
			for {
				...
				log.Infof("WATCHER: startupFn: Starting WatchAppealGranted")
				...
				if err != nil {
					if sub != nil {
						log.Infof("WATCHER: startupFn: Unsubscribing WatchAppealGranted")
						sub.Unsubscribe()
					}
					if retry >= maxRetries {
						return nil, nil, err
					...
					retry++
					log.Warningf("WATCHER: startupFn: Retrying start WatchAppealGranted: %v", err)
					continue
				}
	...
	return event.NewSubscription(func(quit <-chan struct{}) error {
		...
		startupFn := func() (event.Subscription, chan *contract.CivilTCRContractAppealRequested, error) {
			...
			for {
				...
				log.Infof("WATCHER: startupFn: Starting WatchAppealRequested")
				...
				if err != nil {
					if sub != nil {
						log.Infof("WATCHER: startupFn: Unsubscribing WatchAppealRequested")
						sub.Unsubscribe()
					}
					if retry >= maxRetries {
						return nil, nil, err
					...
					retry++
					log.Warningf("WATCHER: startupFn: Retrying start WatchAppealRequested: %v", err)
					continue
				}
				return sub, recvChan, nil
			}
	...
	return event.NewSubscription(func(quit <-chan struct{}) error {
		...
		startupFn := func() (event.Subscription, chan *contract.CivilTCRContractApplication, error) {
			...
			for {
				...
				log.Infof("WATCHER: startupFn: Starting WatchApplication")
				...
				if err != nil {
					if sub != nil {
						log.Infof("WATCHER: startupFn: Unsubscribing WatchApplication")
						sub.Unsubscribe()
					}
					if retry >= maxRetries {
						return nil, nil, err
					...
					retry++
					log.Warningf("WATCHER: startupFn: Retrying start WatchApplication: %v", err)
					continue
				}
				return sub, recvChan, nil
			}
	...
	return event.NewSubscription(func(quit <-chan struct{}) error {
		...
		startupFn := func() (event.Subscription, chan *contract.CivilTCRContractApplicationRemoved, error) {
			...
			for {
				...
				log.Infof("WATCHER: startupFn: Starting WatchApplicationRemoved")
				...
				if err != nil {
					if sub != nil {
						log.Infof("WATCHER: startupFn: Unsubscribing WatchApplicationRemoved")
						sub.Unsubscribe()
					}
					if retry >= maxRetries {
						return nil, nil, err
					...
					retry++
					log.Warningf("WATCHER: startupFn: Retrying start WatchApplicationRemoved: %v", err)
					continue
				}
				return sub, recvChan, nil
			}
	...
	return event.NewSubscription(func(quit <-chan struct{}) error {
		...
		startupFn := func() (event.Subscription, chan *contract.CivilTCRContractApplicationWhitelisted, error) {
			...
			for {
				...
				log.Infof("WATCHER: startupFn: Starting WatchApplicationWhitelisted")
				...
				if err != nil {
					if sub != nil {
						log.Infof("WATCHER: startupFn: Unsubscribing WatchApplicationWhitelisted")
						sub.Unsubscribe()
					}
					if retry >= maxRetries {
						return nil, nil, err
					...
					retry++
					log.Warningf("WATCHER: startupFn: Retrying start WatchApplicationWhitelisted: %v", err)
					continue
				}
				return sub, recvChan, nil
			}
	...
	return event.NewSubscription(func(quit <-chan struct{}) error {
		...
		startupFn := func() (event.Subscription, chan *contract.CivilTCRContractChallenge, error) {
			...
			for {
				...
				log.Infof("WATCHER: startupFn: Starting WatchChallenge")
				...
				if err != nil {
					if sub != nil {
						log.Infof("WATCHER: startupFn: Unsubscribing WatchChallenge")
						sub.Unsubscribe()
					}
					if retry >= maxRetries {
						return nil, nil, err
					...
					retry++
					log.Warningf("WATCHER: startupFn: Retrying start WatchChallenge: %v", err)
					continue
				}
				return sub, recvChan, nil
			}
	...
	return event.NewSubscription(func(quit <-chan struct{}) error {
		...
		startupFn := func() (event.Subscription, chan *contract.CivilTCRContractChallengeFailed, error) {
			...
			for {
				...
				log.Infof("WATCHER: startupFn: Starting WatchChallengeFailed")
				...
				if err != nil {
					if sub != nil {
						log.Infof("WATCHER: startupFn: Unsubscribing WatchChallengeFailed")
						sub.Unsubscribe()
					}
					if retry >= maxRetries {
						return nil, nil, err
					...
					retry++
					log.Warningf("WATCHER: startupFn: Retrying start WatchChallengeFailed: %v", err)
					continue
				}
				return sub, recvChan, nil
			}
	...
	return event.NewSubscription(func(quit <-chan struct{}) error {
		...
		startupFn := func() (event.Subscription, chan *contract.CivilTCRContractChallengeSucceeded, error) {
			...
			for {
				...
				log.Infof("WATCHER: startupFn: Starting WatchChallengeSucceeded")
				...
				if err != nil {
					if sub != nil {
						log.Infof("WATCHER: startupFn: Unsubscribing WatchChallengeSucceeded")
						sub.Unsubscribe()
					}
					if retry >= maxRetries {
						return nil, nil, err
					...
					retry++
					log.Warningf("WATCHER: startupFn: Retrying start WatchChallengeSucceeded: %v", err)
					continue
				}
				return sub, recvChan, nil
			}
	...
	return event.NewSubscription(func(quit <-chan struct{}) error {
		...
		startupFn := func() (event.Subscription, chan *contract.CivilTCRContractDeposit, error) {
			...
			for {
				...
				log.Infof("WATCHER: startupFn: Starting WatchDeposit")
				...
				if err != nil {
					if sub != nil {
						log.Infof("WATCHER: startupFn: Unsubscribing WatchDeposit")
						sub.Unsubscribe()
					}
					if retry >= maxRetries {
						return nil, nil, err
					...
					retry++
					log.Warningf("WATCHER: startupFn: Retrying start WatchDeposit: %v", err)
					continue
				}
				return sub, recvChan, nil
			}
	...
	return event.NewSubscription(func(quit <-chan struct{}) error {
		...
		startupFn := func() (event.Subscription, chan *contract.CivilTCRContractFailedChallengeOverturned, error) {
			...
			for {
				...
				log.Infof("WATCHER: startupFn: Starting WatchFailedChallengeOverturned")
				...
				if err != nil {
					if sub != nil {
						log.Infof("WATCHER: startupFn: Unsubscribing WatchFailedChallengeOverturned")
						sub.Unsubscribe()
					}
					if retry >= maxRetries {
						return nil, nil, err
					...
					retry++
					log.Warningf("WATCHER: startupFn: Retrying start WatchFailedChallengeOverturned: %v", err)
					continue
				}
				return sub, recvChan, nil
			}
	...
	return event.NewSubscription(func(quit <-chan struct{}) error {
		...
		startupFn := func() (event.Subscription, chan *contract.CivilTCRContractGovernmentTransfered, error) {
			...
			for {
				...
				log.Infof("WATCHER: startupFn: Starting WatchGovernmentTransfered")
				...
				if err != nil {
					if sub != nil {
						log.Infof("WATCHER: startupFn: Unsubscribing WatchGovernmentTransfered")
						sub.Unsubscribe()
					}
					if retry >= maxRetries {
						return nil, nil, err
					...
					retry++
					log.Warningf("WATCHER: startupFn: Retrying start WatchGovernmentTransfered: %v", err)
					continue
				}
				return sub, recvChan, nil
			}
	...
	return event.NewSubscription(func(quit <-chan struct{}) error {
		...
		startupFn := func() (event.Subscription, chan *contract.CivilTCRContractGrantedAppealChallenged, error) {
			...
			for {
				...
				log.Infof("WATCHER: startupFn: Starting WatchGrantedAppealChallenged")
				...
				if err != nil {
					if sub != nil {
						log.Infof("WATCHER: startupFn: Unsubscribing WatchGrantedAppealChallenged")
						sub.Unsubscribe()
					}
					if retry >= maxRetries {
						return nil, nil, err
					...
					retry++
					log.Warningf("WATCHER: startupFn: Retrying start WatchGrantedAppealChallenged: %v", err)
					continue
				}
				return sub, recvChan, nil
			}
	...
	return event.NewSubscription(func(quit <-chan struct{}) error {
		...
		startupFn := func() (event.Subscription, chan *contract.CivilTCRContractGrantedAppealConfirmed, error) {
			...
			for {
				...
				log.Infof("WATCHER: startupFn: Starting WatchGrantedAppealConfirmed")
				...
				if err != nil {
					if sub != nil {
						log.Infof("WATCHER: startupFn: Unsubscribing WatchGrantedAppealConfirmed")
						sub.Unsubscribe()
					}
					if retry >= maxRetries {
						return nil, nil, err
					...
					retry++
					log.Warningf("WATCHER: startupFn: Retrying start WatchGrantedAppealConfirmed: %v", err)
					continue
				}
				return sub, recvChan, nil
			}
	...
	return event.NewSubscription(func(quit <-chan struct{}) error {
		...
		startupFn := func() (event.Subscription, chan *contract.CivilTCRContractGrantedAppealOverturned, error) {
			...
			for {
				...
				log.Infof("WATCHER: startupFn: Starting WatchGrantedAppealOverturned")
				...
				if err != nil {
					if sub != nil {
						log.Infof("WATCHER: startupFn: Unsubscribing WatchGrantedAppealOverturned")
						sub.Unsubscribe()
					}
					if retry >= maxRetries {
						return nil, nil, err
					...
					retry++
					log.Warningf("WATCHER: startupFn: Retrying start WatchGrantedAppealOverturned: %v", err)
					continue
				}
				return sub, recvChan, nil
			}
	...
	return event.NewSubscription(func(quit <-chan struct{}) error {
		...
		startupFn := func() (event.Subscription, chan *contract.CivilTCRContractListingRemoved, error) {
			...
			for {
				...
				log.Infof("WATCHER: startupFn: Starting WatchListingRemoved")
				...
				if err != nil {
					if sub != nil {
						log.Infof("WATCHER: startupFn: Unsubscribing WatchListingRemoved")
						sub.Unsubscribe()
					}
					if retry >= maxRetries {
						return nil, nil, err
					...
					retry++
					log.Warningf("WATCHER: startupFn: Retrying start WatchListingRemoved: %v", err)
					continue
				}
				return sub, recvChan, nil
			}
	...
	return event.NewSubscription(func(quit <-chan struct{}) error {
		...
		startupFn := func() (event.Subscription, chan *contract.CivilTCRContractListingWithdrawn, error) {
			...
			for {
				...
				log.Infof("WATCHER: startupFn: Starting WatchListingWithdrawn")
				...
				if err != nil {
					if sub != nil {
						log.Infof("WATCHER: startupFn: Unsubscribing WatchListingWithdrawn")
						sub.Unsubscribe()
					}
					if retry >= maxRetries {
						return nil, nil, err
					...
					retry++
					log.Warningf("WATCHER: startupFn: Retrying start WatchListingWithdrawn: %v", err)
					continue
				}
				return sub, recvChan, nil
			}
	...
	return event.NewSubscription(func(quit <-chan struct{}) error {
		...
		startupFn := func() (event.Subscription, chan *contract.CivilTCRContractRewardClaimed, error) {
			...
			for {
				...
				log.Infof("WATCHER: startupFn: Starting WatchRewardClaimed")
				...
				if err != nil {
					if sub != nil {
						log.Infof("WATCHER: startupFn: Unsubscribing WatchRewardClaimed")
						sub.Unsubscribe()
					}
					if retry >= maxRetries {
						return nil, nil, err
					...
					retry++
					log.Warningf("WATCHER: startupFn: Retrying start WatchRewardClaimed: %v", err)
					continue
				}
				return sub, recvChan, nil
			}
	...
	return event.NewSubscription(func(quit <-chan struct{}) error {
		...
		startupFn := func() (event.Subscription, chan *contract.CivilTCRContractSuccessfulChallengeOverturned, error) {
			...
			for {
				...
				log.Infof("WATCHER: startupFn: Starting WatchSuccessfulChallengeOverturned")
				...
				if err != nil {
					if sub != nil {
						log.Infof("WATCHER: startupFn: Unsubscribing WatchSuccessfulChallengeOverturned")
						sub.Unsubscribe()
					}
					if retry >= maxRetries {
						return nil, nil, err
					...
					retry++
					log.Warningf("WATCHER: startupFn: Retrying start WatchSuccessfulChallengeOverturned: %v", err)
					continue
				}
				return sub, recvChan, nil
			}
	...
	return event.NewSubscription(func(quit <-chan struct{}) error {
		...
		startupFn := func() (event.Subscription, chan *contract.CivilTCRContractTouchAndRemoved, error) {
			...
			for {
				...
				log.Infof("WATCHER: startupFn: Starting WatchTouchAndRemoved")
				...
				if err != nil {
					if sub != nil {
						log.Infof("WATCHER: startupFn: Unsubscribing WatchTouchAndRemoved")
						sub.Unsubscribe()
					}
					if retry >= maxRetries {
						return nil, nil, err
					...
					retry++
					log.Warningf("WATCHER: startupFn: Retrying start WatchTouchAndRemoved: %v", err)
					continue
				}
				return sub, recvChan, nil
			}
	...
	return event.NewSubscription(func(quit <-chan struct{}) error {
		...
		startupFn := func() (event.Subscription, chan *contract.CivilTCRContractWithdrawal, error) {
			...
			for {
				...
				log.Infof("WATCHER: startupFn: Starting WatchWithdrawal")
				...
				if err != nil {
					if sub != nil {
						log.Infof("WATCHER: startupFn: Unsubscribing WatchWithdrawal")
						sub.Unsubscribe()
					}
					if retry >= maxRetries {
						return nil, nil, err
					...
					retry++
					log.Warningf("WATCHER: startupFn: Retrying start WatchWithdrawal: %v", err)
					continue
				}
				return sub, recvChan, nil
			}
