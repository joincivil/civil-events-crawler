...
// File was generated at 2019-12-05 18:54:47.002821 +0000 UTC
package watcher
...
func NewCivilTCRContractWatchersAllEvents(contractAddress common.Address) *CivilTCRContractWatchers {
	return &CivilTCRContractWatchers{
		contractAddress: contractAddress,
		enableAll:       true,
	}
...
func (w *CivilTCRContractWatchers) StartCivilTCRContractWatchers(client bind.ContractBackend,
	...
	if w.enableAll || specs.IsListenerEnabledForEvent("CivilTCRContract", "AppealGranted") {
	...
	if w.enableAll || specs.IsListenerEnabledForEvent("CivilTCRContract", "AppealRequested") {
	...
	if w.enableAll || specs.IsListenerEnabledForEvent("CivilTCRContract", "Application") {
	...
	if w.enableAll || specs.IsListenerEnabledForEvent("CivilTCRContract", "ApplicationRemoved") {
	...
	if w.enableAll || specs.IsListenerEnabledForEvent("CivilTCRContract", "ApplicationWhitelisted") {
	...
	if w.enableAll || specs.IsListenerEnabledForEvent("CivilTCRContract", "Challenge") {
	...
	if w.enableAll || specs.IsListenerEnabledForEvent("CivilTCRContract", "ChallengeFailed") {
	...
	if w.enableAll || specs.IsListenerEnabledForEvent("CivilTCRContract", "ChallengeSucceeded") {
	...
	if w.enableAll || specs.IsListenerEnabledForEvent("CivilTCRContract", "Deposit") {
	...
	if w.enableAll || specs.IsListenerEnabledForEvent("CivilTCRContract", "FailedChallengeOverturned") {
	...
	if w.enableAll || specs.IsListenerEnabledForEvent("CivilTCRContract", "GovernmentTransfered") {
	...
	if w.enableAll || specs.IsListenerEnabledForEvent("CivilTCRContract", "GrantedAppealChallenged") {
	...
	if w.enableAll || specs.IsListenerEnabledForEvent("CivilTCRContract", "GrantedAppealConfirmed") {
	...
	if w.enableAll || specs.IsListenerEnabledForEvent("CivilTCRContract", "GrantedAppealOverturned") {
	...
	if w.enableAll || specs.IsListenerEnabledForEvent("CivilTCRContract", "ListingRemoved") {
	...
	if w.enableAll || specs.IsListenerEnabledForEvent("CivilTCRContract", "ListingWithdrawn") {
	...
	if w.enableAll || specs.IsListenerEnabledForEvent("CivilTCRContract", "RewardClaimed") {
	...
	if w.enableAll || specs.IsListenerEnabledForEvent("CivilTCRContract", "SuccessfulChallengeOverturned") {
	...
	if w.enableAll || specs.IsListenerEnabledForEvent("CivilTCRContract", "TouchAndRemoved") {
	...
	if w.enableAll || specs.IsListenerEnabledForEvent("CivilTCRContract", "Withdrawal") {
	...
	return utils.NewWatcherSubscription("WatchAppealGranted", func(quit <-chan struct{}) error {
		...
		for {
			...
			case <-time.After(time.Second * time.Duration(preemptiveTimeoutSecs)):
				...
				sub, recvChan, err = startupFn()
				if err != nil {
					log.Errorf("Error starting AppealGranted: addr: %v, %v", w.contractAddress.Hex(), err)
					w.errors <- err
					return err
				}
				log.Infof("Attempting to unsub old AppealGranted")
				oldSub.Unsubscribe()
				log.Infof("Done preemptive restart AppealGranted: addr: %v", w.contractAddress.Hex())
			case event := <-recvChan:
				if log.V(2) {
	...
	return utils.NewWatcherSubscription("WatchAppealRequested", func(quit <-chan struct{}) error {
		...
		for {
			...
			case <-time.After(time.Second * time.Duration(preemptiveTimeoutSecs)):
				...
				sub, recvChan, err = startupFn()
				if err != nil {
					log.Errorf("Error starting AppealRequested: addr: %v, %v", w.contractAddress.Hex(), err)
					w.errors <- err
					return err
				}
				log.Infof("Attempting to unsub old AppealRequested")
				oldSub.Unsubscribe()
				log.Infof("Done preemptive restart AppealRequested: addr: %v", w.contractAddress.Hex())
			case event := <-recvChan:
				if log.V(2) {
	...
	return utils.NewWatcherSubscription("WatchApplication", func(quit <-chan struct{}) error {
		...
		for {
			...
			case <-time.After(time.Second * time.Duration(preemptiveTimeoutSecs)):
				...
				sub, recvChan, err = startupFn()
				if err != nil {
					log.Errorf("Error starting Application: addr: %v, %v", w.contractAddress.Hex(), err)
					w.errors <- err
					return err
				}
				log.Infof("Attempting to unsub old Application")
				oldSub.Unsubscribe()
				log.Infof("Done preemptive restart Application: addr: %v", w.contractAddress.Hex())
			case event := <-recvChan:
				if log.V(2) {
	...
	return utils.NewWatcherSubscription("WatchApplicationRemoved", func(quit <-chan struct{}) error {
		...
		for {
			...
			case <-time.After(time.Second * time.Duration(preemptiveTimeoutSecs)):
				...
				sub, recvChan, err = startupFn()
				if err != nil {
					log.Errorf("Error starting ApplicationRemoved: addr: %v, %v", w.contractAddress.Hex(), err)
					w.errors <- err
					return err
				}
				log.Infof("Attempting to unsub old ApplicationRemoved")
				oldSub.Unsubscribe()
				log.Infof("Done preemptive restart ApplicationRemoved: addr: %v", w.contractAddress.Hex())
			case event := <-recvChan:
				if log.V(2) {
	...
	return utils.NewWatcherSubscription("WatchApplicationWhitelisted", func(quit <-chan struct{}) error {
		...
		for {
			...
			case <-time.After(time.Second * time.Duration(preemptiveTimeoutSecs)):
				...
				sub, recvChan, err = startupFn()
				if err != nil {
					log.Errorf("Error starting ApplicationWhitelisted: addr: %v, %v", w.contractAddress.Hex(), err)
					w.errors <- err
					return err
				}
				log.Infof("Attempting to unsub old ApplicationWhitelisted")
				oldSub.Unsubscribe()
				log.Infof("Done preemptive restart ApplicationWhitelisted: addr: %v", w.contractAddress.Hex())
			case event := <-recvChan:
				if log.V(2) {
	...
	return utils.NewWatcherSubscription("WatchChallenge", func(quit <-chan struct{}) error {
		...
		for {
			...
			case <-time.After(time.Second * time.Duration(preemptiveTimeoutSecs)):
				...
				sub, recvChan, err = startupFn()
				if err != nil {
					log.Errorf("Error starting Challenge: addr: %v, %v", w.contractAddress.Hex(), err)
					w.errors <- err
					return err
				}
				log.Infof("Attempting to unsub old Challenge")
				oldSub.Unsubscribe()
				log.Infof("Done preemptive restart Challenge: addr: %v", w.contractAddress.Hex())
			case event := <-recvChan:
				if log.V(2) {
	...
	return utils.NewWatcherSubscription("WatchDeposit", func(quit <-chan struct{}) error {
		...
		for {
			...
			case <-time.After(time.Second * time.Duration(preemptiveTimeoutSecs)):
				...
				sub, recvChan, err = startupFn()
				if err != nil {
					log.Errorf("Error starting Deposit: addr: %v, %v", w.contractAddress.Hex(), err)
					w.errors <- err
					return err
				}
				log.Infof("Attempting to unsub old Deposit")
				oldSub.Unsubscribe()
				log.Infof("Done preemptive restart Deposit: addr: %v", w.contractAddress.Hex())
			case event := <-recvChan:
				if log.V(2) {
	...
	return utils.NewWatcherSubscription("WatchFailedChallengeOverturned", func(quit <-chan struct{}) error {
		...
		for {
			...
			case <-time.After(time.Second * time.Duration(preemptiveTimeoutSecs)):
				...
				sub, recvChan, err = startupFn()
				if err != nil {
					log.Errorf("Error starting FailedChallengeOverturned: addr: %v, %v", w.contractAddress.Hex(), err)
					w.errors <- err
					return err
				}
				log.Infof("Attempting to unsub old FailedChallengeOverturned")
				oldSub.Unsubscribe()
				log.Infof("Done preemptive restart FailedChallengeOverturned: addr: %v", w.contractAddress.Hex())
			case event := <-recvChan:
				if log.V(2) {
	...
	return utils.NewWatcherSubscription("WatchGovernmentTransfered", func(quit <-chan struct{}) error {
		...
		for {
			...
			case <-time.After(time.Second * time.Duration(preemptiveTimeoutSecs)):
				...
				sub, recvChan, err = startupFn()
				if err != nil {
					log.Errorf("Error starting GovernmentTransfered: addr: %v, %v", w.contractAddress.Hex(), err)
					w.errors <- err
					return err
				}
				log.Infof("Attempting to unsub old GovernmentTransfered")
				oldSub.Unsubscribe()
				log.Infof("Done preemptive restart GovernmentTransfered: addr: %v", w.contractAddress.Hex())
			case event := <-recvChan:
				if log.V(2) {
	...
	return utils.NewWatcherSubscription("WatchGrantedAppealChallenged", func(quit <-chan struct{}) error {
		...
		for {
			...
			case <-time.After(time.Second * time.Duration(preemptiveTimeoutSecs)):
				...
				sub, recvChan, err = startupFn()
				if err != nil {
					log.Errorf("Error starting GrantedAppealChallenged: addr: %v, %v", w.contractAddress.Hex(), err)
					w.errors <- err
					return err
				}
				log.Infof("Attempting to unsub old GrantedAppealChallenged")
				oldSub.Unsubscribe()
				log.Infof("Done preemptive restart GrantedAppealChallenged: addr: %v", w.contractAddress.Hex())
			case event := <-recvChan:
				if log.V(2) {
	...
	return utils.NewWatcherSubscription("WatchGrantedAppealConfirmed", func(quit <-chan struct{}) error {
		...
		for {
			...
			case <-time.After(time.Second * time.Duration(preemptiveTimeoutSecs)):
				...
				sub, recvChan, err = startupFn()
				if err != nil {
					log.Errorf("Error starting GrantedAppealConfirmed: addr: %v, %v", w.contractAddress.Hex(), err)
					w.errors <- err
					return err
				}
				log.Infof("Attempting to unsub old GrantedAppealConfirmed")
				oldSub.Unsubscribe()
				log.Infof("Done preemptive restart GrantedAppealConfirmed: addr: %v", w.contractAddress.Hex())
			case event := <-recvChan:
				if log.V(2) {
	...
	return utils.NewWatcherSubscription("WatchGrantedAppealOverturned", func(quit <-chan struct{}) error {
		...
		for {
			...
			case <-time.After(time.Second * time.Duration(preemptiveTimeoutSecs)):
				...
				sub, recvChan, err = startupFn()
				if err != nil {
					log.Errorf("Error starting GrantedAppealOverturned: addr: %v, %v", w.contractAddress.Hex(), err)
					w.errors <- err
					return err
				}
				log.Infof("Attempting to unsub old GrantedAppealOverturned")
				oldSub.Unsubscribe()
				log.Infof("Done preemptive restart GrantedAppealOverturned: addr: %v", w.contractAddress.Hex())
			case event := <-recvChan:
				if log.V(2) {
	...
	return utils.NewWatcherSubscription("WatchListingRemoved", func(quit <-chan struct{}) error {
		...
		for {
			...
			case <-time.After(time.Second * time.Duration(preemptiveTimeoutSecs)):
				...
				sub, recvChan, err = startupFn()
				if err != nil {
					log.Errorf("Error starting ListingRemoved: addr: %v, %v", w.contractAddress.Hex(), err)
					w.errors <- err
					return err
				}
				log.Infof("Attempting to unsub old ListingRemoved")
				oldSub.Unsubscribe()
				log.Infof("Done preemptive restart ListingRemoved: addr: %v", w.contractAddress.Hex())
			case event := <-recvChan:
				if log.V(2) {
	...
	return utils.NewWatcherSubscription("WatchListingWithdrawn", func(quit <-chan struct{}) error {
		...
		for {
			...
			case <-time.After(time.Second * time.Duration(preemptiveTimeoutSecs)):
				...
				sub, recvChan, err = startupFn()
				if err != nil {
					log.Errorf("Error starting ListingWithdrawn: addr: %v, %v", w.contractAddress.Hex(), err)
					w.errors <- err
					return err
				}
				log.Infof("Attempting to unsub old ListingWithdrawn")
				oldSub.Unsubscribe()
				log.Infof("Done preemptive restart ListingWithdrawn: addr: %v", w.contractAddress.Hex())
			case event := <-recvChan:
				if log.V(2) {
	...
	return utils.NewWatcherSubscription("WatchSuccessfulChallengeOverturned", func(quit <-chan struct{}) error {
		...
		for {
			...
			case <-time.After(time.Second * time.Duration(preemptiveTimeoutSecs)):
				...
				sub, recvChan, err = startupFn()
				if err != nil {
					log.Errorf("Error starting SuccessfulChallengeOverturned: addr: %v, %v", w.contractAddress.Hex(), err)
					w.errors <- err
					return err
				}
				log.Infof("Attempting to unsub old SuccessfulChallengeOverturned")
				oldSub.Unsubscribe()
				log.Infof("Done preemptive restart SuccessfulChallengeOverturned: addr: %v", w.contractAddress.Hex())
			case event := <-recvChan:
				if log.V(2) {
	...
	return utils.NewWatcherSubscription("WatchTouchAndRemoved", func(quit <-chan struct{}) error {
		...
		for {
			...
			case <-time.After(time.Second * time.Duration(preemptiveTimeoutSecs)):
				...
				sub, recvChan, err = startupFn()
				if err != nil {
					log.Errorf("Error starting TouchAndRemoved: addr: %v, %v", w.contractAddress.Hex(), err)
					w.errors <- err
					return err
				}
				log.Infof("Attempting to unsub old TouchAndRemoved")
				oldSub.Unsubscribe()
				log.Infof("Done preemptive restart TouchAndRemoved: addr: %v", w.contractAddress.Hex())
			case event := <-recvChan:
				if log.V(2) {
	...
	return utils.NewWatcherSubscription("WatchWithdrawal", func(quit <-chan struct{}) error {
		...
		for {
			...
			case <-time.After(time.Second * time.Duration(preemptiveTimeoutSecs)):
				...
				sub, recvChan, err = startupFn()
				if err != nil {
					log.Errorf("Error starting Withdrawal: addr: %v, %v", w.contractAddress.Hex(), err)
					w.errors <- err
					return err
				}
				log.Infof("Attempting to unsub old Withdrawal")
				oldSub.Unsubscribe()
				log.Infof("Done preemptive restart Withdrawal: addr: %v", w.contractAddress.Hex())
			case event := <-recvChan:
				if log.V(2) {
