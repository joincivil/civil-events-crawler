...
// File was generated at 2019-12-19 21:32:15.596533 +0000 UTC
package watcher
...
func (w *GovernmentContractWatchers) cancelFunc(cancelFn context.CancelFunc, killCancel <-chan struct{}) {
}
...
func (w *GovernmentContractWatchers) StartGovernmentContractWatchers(client bind.ContractBackend,
	...
	if specs.IsListenerEnabledForEvent("GovernmentContract", "AppellateSet") {
	...
	if specs.IsListenerEnabledForEvent("GovernmentContract", "GovtReparameterizationProposal") {
	...
	if specs.IsListenerEnabledForEvent("GovernmentContract", "NewConstSet") {
	...
	if specs.IsListenerEnabledForEvent("GovernmentContract", "ParameterSet") {
	...
	if specs.IsListenerEnabledForEvent("GovernmentContract", "ProposalExpired") {
	...
	if specs.IsListenerEnabledForEvent("GovernmentContract", "ProposalFailed") {
	...
	if specs.IsListenerEnabledForEvent("GovernmentContract", "ProposalPassed") {
