...
// File was generated at 2019-03-05 02:17:44.21677 +0000 UTC
package watcher
	...
	return event.NewSubscription(func(quit <-chan struct{}) error {
		...
		startupFn := func() (event.Subscription, chan *contract.NewsroomContractContentPublished, error) {
			...
			for {
				...
				log.Infof("WATCHER: startupFn: Starting WatchContentPublished")
				...
				if err != nil {
					if sub != nil {
						log.Infof("WATCHER: startupFn: Unsubscribing WatchContentPublished")
						sub.Unsubscribe()
					}
					if retry >= maxRetries {
						return nil, nil, err
					...
					retry++
					log.Warningf("WATCHER: startupFn: Retrying start WatchContentPublished: %v", err)
					continue
				}
	...
	return event.NewSubscription(func(quit <-chan struct{}) error {
		...
		startupFn := func() (event.Subscription, chan *contract.NewsroomContractNameChanged, error) {
			...
			for {
				...
				log.Infof("WATCHER: startupFn: Starting WatchNameChanged")
				...
				if err != nil {
					if sub != nil {
						log.Infof("WATCHER: startupFn: Unsubscribing WatchNameChanged")
						sub.Unsubscribe()
					}
					if retry >= maxRetries {
						return nil, nil, err
					...
					retry++
					log.Warningf("WATCHER: startupFn: Retrying start WatchNameChanged: %v", err)
					continue
				}
				return sub, recvChan, nil
			}
	...
	return event.NewSubscription(func(quit <-chan struct{}) error {
		...
		startupFn := func() (event.Subscription, chan *contract.NewsroomContractOwnershipRenounced, error) {
			...
			for {
				...
				log.Infof("WATCHER: startupFn: Starting WatchOwnershipRenounced")
				...
				if err != nil {
					if sub != nil {
						log.Infof("WATCHER: startupFn: Unsubscribing WatchOwnershipRenounced")
						sub.Unsubscribe()
					}
					if retry >= maxRetries {
						return nil, nil, err
					...
					retry++
					log.Warningf("WATCHER: startupFn: Retrying start WatchOwnershipRenounced: %v", err)
					continue
				}
				return sub, recvChan, nil
			}
	...
	return event.NewSubscription(func(quit <-chan struct{}) error {
		...
		startupFn := func() (event.Subscription, chan *contract.NewsroomContractOwnershipTransferred, error) {
			...
			for {
				...
				log.Infof("WATCHER: startupFn: Starting WatchOwnershipTransferred")
				...
				if err != nil {
					if sub != nil {
						log.Infof("WATCHER: startupFn: Unsubscribing WatchOwnershipTransferred")
						sub.Unsubscribe()
					}
					if retry >= maxRetries {
						return nil, nil, err
					...
					retry++
					log.Warningf("WATCHER: startupFn: Retrying start WatchOwnershipTransferred: %v", err)
					continue
				}
				return sub, recvChan, nil
			}
	...
	return event.NewSubscription(func(quit <-chan struct{}) error {
		...
		startupFn := func() (event.Subscription, chan *contract.NewsroomContractRevisionSigned, error) {
			...
			for {
				...
				log.Infof("WATCHER: startupFn: Starting WatchRevisionSigned")
				...
				if err != nil {
					if sub != nil {
						log.Infof("WATCHER: startupFn: Unsubscribing WatchRevisionSigned")
						sub.Unsubscribe()
					}
					if retry >= maxRetries {
						return nil, nil, err
					...
					retry++
					log.Warningf("WATCHER: startupFn: Retrying start WatchRevisionSigned: %v", err)
					continue
				}
				return sub, recvChan, nil
			}
	...
	return event.NewSubscription(func(quit <-chan struct{}) error {
		...
		startupFn := func() (event.Subscription, chan *contract.NewsroomContractRevisionUpdated, error) {
			...
			for {
				...
				log.Infof("WATCHER: startupFn: Starting WatchRevisionUpdated")
				...
				if err != nil {
					if sub != nil {
						log.Infof("WATCHER: startupFn: Unsubscribing WatchRevisionUpdated")
						sub.Unsubscribe()
					}
					if retry >= maxRetries {
						return nil, nil, err
					...
					retry++
					log.Warningf("WATCHER: startupFn: Retrying start WatchRevisionUpdated: %v", err)
					continue
				}
				return sub, recvChan, nil
			}
	...
	return event.NewSubscription(func(quit <-chan struct{}) error {
		...
		startupFn := func() (event.Subscription, chan *contract.NewsroomContractRoleAdded, error) {
			...
			for {
				...
				log.Infof("WATCHER: startupFn: Starting WatchRoleAdded")
				...
				if err != nil {
					if sub != nil {
						log.Infof("WATCHER: startupFn: Unsubscribing WatchRoleAdded")
						sub.Unsubscribe()
					}
					if retry >= maxRetries {
						return nil, nil, err
					...
					retry++
					log.Warningf("WATCHER: startupFn: Retrying start WatchRoleAdded: %v", err)
					continue
				}
				return sub, recvChan, nil
			}
	...
	return event.NewSubscription(func(quit <-chan struct{}) error {
		...
		startupFn := func() (event.Subscription, chan *contract.NewsroomContractRoleRemoved, error) {
			...
			for {
				...
				log.Infof("WATCHER: startupFn: Starting WatchRoleRemoved")
				...
				if err != nil {
					if sub != nil {
						log.Infof("WATCHER: startupFn: Unsubscribing WatchRoleRemoved")
						sub.Unsubscribe()
					}
					if retry >= maxRetries {
						return nil, nil, err
					...
					retry++
					log.Warningf("WATCHER: startupFn: Retrying start WatchRoleRemoved: %v", err)
					continue
				}
				return sub, recvChan, nil
			}
