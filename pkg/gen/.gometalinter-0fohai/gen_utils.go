...
// 	}
// 	NameToTemp = NameToContractType{
// 		"civiltcr": CivilTcrContractType,
// 		"newsroom": NewsroomContractType,
// 	}
// )

// PackageToTemplateNames := map[string]const{"watcher": watcherTmpl,
...
// type PackageToTemplateNames map[string]PackageType
...
// func GenerateWatchersFromTemplate(writer io.Writer, watchers *ContractWatchers, gofmt bool, packageName string) error {
// 	switch packageName{
// 		case "watcher":
...
// 	}
// 	return GenerateWatchersFromTemplate(writer, watchers, true, packageName)
// }
